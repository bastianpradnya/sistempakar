<?php
  ...
  $sql1    = "UPDATE temp_konsultasi SET temp_belief = '0.1' WHERE temp_konsultasi.temp_kode_gejala = 'G008'";
  ...
  echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../g015-2/g015-2.php">';
?>
