<?php
  ...
  $sql2    = "UPDATE temp_konsultasi SET temp_belief = '0.4' WHERE temp_konsultasi.temp_kode_gejala = 'G009'";
  $tambah2 = mysqli_query($konek, $sql2);
  if(!$tambah2){
      die ("Gagal Query..".mysqli_error($konek));
  }
  $sql1    = "UPDATE temp_konsultasi SET temp_belief = '0.6' WHERE temp_konsultasi.temp_kode_gejala = 'G022'";
  $tambah1 = mysqli_query($konek, $sql1);
  if(!$tambah1){
      die ("Gagal Query..".mysqli_error($konek));
  }
  echo '<META HTTP-EQUIV="Refresh" Content="0; URL=../g024/g024.php">';
?>
