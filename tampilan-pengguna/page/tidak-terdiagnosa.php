...
<html lang="en">
  ...
  <body class="bg-dark">
    ...
    <div class="container">
      ...
      <div class="card-header">Hasil Tidak Terdiagnosa!</div>
        <div class="card-body">
          <a href=../process/delete/hapus-semua-konsultasi.php class="btn btn-info">OK</a>
        </div>
      </div>
    </div>
    </div>
