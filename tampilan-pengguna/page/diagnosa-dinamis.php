...
<?php
  ...
  $nama = "$key = $value[0]";
  //echo $nama; // menampilkan nama penyakit pada array indeks pertama
  ...
  $sql_simpan = "INSERT INTO temp_hasil (`nama_penyakit`) VALUES ('$nama')";
  ...
  if(!$hasil_simpan){
    ...
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=diagnosa-dinamis-hasil.php">';
}
?>
