...
INSERT INTO `basis_pengetahuan` (`id_pengetahuan`, `kode_penyakit`, `kode_gejala`, `nilai_belief`) VALUES
(6, 'P001', 'G001', 0.8),
(7, 'P001', 'G002', 0.2),
(8, 'P001', 'G003', 0.4),
(9, 'P001', 'G004', 0.2),
...
--
ALTER TABLE `basis_pengetahuan`
  MODIFY `id_pengetahuan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
